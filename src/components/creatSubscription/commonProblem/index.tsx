...
const CommonProblem = () => {
  return (
    <View className="m-4 pb-14">
      <View className="my-2">
        <View className="flex items-center justify-center w-full font-bold">
          <IconFont name="changjianwenti" size={50} /> 常见问题
        </View>
      </View>
      <View>
        <View className="flex flex-row">
          <View className="w-5 h-5 bg-primary-red rounded-full text-white text-center mr-2 leading-5">1</View>
          <Text>什么是订阅?</Text>
        </View>
        <View className="py-5 pr-5 pl-7 text-sm">
          一次付款，按月逐包送货上门，无需屯粮，更不用担心爱宠断粮。我们也将根据您家宠物的年龄、品种、体型推荐精准营养，并提供每日科学饲喂量，让您放心养宠。
        </View>
      </View>
      <View className="mb-5">
        <View className="flex flex-row">
          <View className="w-5 h-5 bg-primary-red rounded-full text-white text-center mr-2 leading-5">2</View>
          <Text>订阅有什么好处?</Text>
        </View>
        <View className="pl-7 pt-2 pt-5 pr-5 text-sm">
        ...
        <View className="pl-7 py-5 pr-5 pt-5 text-sm">
